/* Generic (общие типы) - это просто обозначение типов в общем виде, они позволяют создавать компоненты способные работать с различными типами,
    а не только с каким-то одним, строго определяя его. Это позволяет применять такие компоненты и использовать свои типы. Т.е. мы сами
    будем задавать определенные типы и контролировать вест процесс.
*/

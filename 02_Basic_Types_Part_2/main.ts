...
// Enum Type - можно использовать для задания понятных имен набору численных значений. Перечисления определяются с помощью ключевого слова enum
            // и они позволяют нам создавать набор именованных числовых констант.

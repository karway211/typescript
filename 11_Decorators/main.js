/*
Decorators - это возможность typescript по добавлению аннотаций и мета-програмного синтаксиса для объявления классов
            и функций. Существует 4 основных типа декоратора: класса, свойства, метода и аксессора.
*/
...
const logProperty = (target: Object, propertyKey: string | symbol) => {
  ...
  /*
  target - это прототип класса к которому применяется декоратор
  propertyKey - имя поля к которому применяется декоратор, тип этого поля либо строка либо символ
  */
};

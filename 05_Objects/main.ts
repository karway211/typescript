...
// Т.о. можно выделить еще несколько плюсов использования typescript, а именно:
// гибкость при создании типов и
// шаринг описанных типов между различными структурами для минимизации кода